    ...
    for img_name in img_files:
        ...
        for flip_mode in flip_modes:
            ...
            for angle in angle_iter:
                ...
                display_name = prefix + img_name if prefix else img_name
                ...
                # 保存图片（保存在 out_dir）
                save_img_name = (prefix + img_name) if prefix else img_name
                ...
                # 同步并保存标签（保存在 out_txt_dir）
                if os.path.exists(txt_path):
                    try:
                        base_txt_name = name_no_ext + ".txt"
                        save_txt_name = (prefix + base_txt_name) if prefix else base_txt_name
